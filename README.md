...
Sou desenvolvedor **Full Stack** apaixonado por tecnologia, Inteligência Artificial e desenvolvimento de soluções inovadoras. Tenho experiência na criação de aplicações web, APIs REST, automação de processos e projetos baseados em IA.
